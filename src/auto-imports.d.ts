...
declare global {
  ...
  const actions: typeof import('./composables/actions')['actions']
  const actionsFile: typeof import('./composables/actions')['actionsFile']
  const actionsState: typeof import('./composables/actions')['actionsState']
  const addDefragmentationStep: typeof import('./composables/state')['addDefragmentationStep']
  const addFileActionStep: typeof import('./composables/state')['addFileActionStep']
  const addFormatStep: typeof import('./composables/state')['addFormatStep']
  const aniInput: typeof import('./composables/state')['aniInput']
  const asyncComputed: typeof import('@vueuse/core')['asyncComputed']
  const autoResetRef: typeof import('@vueuse/core')['autoResetRef']
  const checkDefragmentationStep: typeof import('./composables/state')['checkDefragmentationStep']
  const checkValidSteps: typeof import('./composables/state')['checkValidSteps']
  ...
  const createAndFormatDisk: typeof import('./composables/state')['createAndFormatDisk']
  ...
  const disk: typeof import('./composables/state')['disk']
  const eagerComputed: typeof import('@vueuse/core')['eagerComputed']
  const effectScope: typeof import('vue')['effectScope']
  const exportModal: typeof import('./composables/exportModal')['exportModal']
  const extendRef: typeof import('@vueuse/core')['extendRef']
  const files: typeof import('./composables/state')['files']
  const fs: typeof import('./composables/state')['fs']
  const generateAnimationState: typeof import('./composables/animations')['generateAnimationState']
  const getCurrentInstance: typeof import('vue')['getCurrentInstance']
  const getCurrentScope: typeof import('vue')['getCurrentScope']
  const getInitialState: typeof import('./composables/animations')['getInitialState']
  const h: typeof import('vue')['h']
  const ignorableWatch: typeof import('@vueuse/core')['ignorableWatch']
  const importModal: typeof import('./composables/importModal')['importModal']
  const initAnimation: typeof import('./composables/animations')['initAnimation']
  const initInitialState: typeof import('./composables/animations')['initInitialState']
  const inject: typeof import('vue')['inject']
  const inputs: typeof import('./composables/state')['inputs']
  ...
  const log: typeof import('./composables/useLog')['log']
  const logicAnd: typeof import('@vueuse/core')['logicAnd']
  const logicNot: typeof import('@vueuse/core')['logicNot']
  const logicOr: typeof import('@vueuse/core')['logicOr']
  const makeDestructurable: typeof import('@vueuse/core')['makeDestructurable']
  const markRaw: typeof import('vue')['markRaw']
  const nextStep: typeof import('./composables/animations')['nextStep']
  const nextTick: typeof import('vue')['nextTick']
  const notify: typeof import('./composables/useNotify')['notify']
  ...
  const parseImportSteps: typeof import('./composables/state')['parseImportSteps']
  ...
  const renderStateClass: typeof import('./composables/actions')['renderStateClass']
  const resetActionsSelectedState: typeof import('./composables/actions')['resetActionsSelectedState']
  const resetActionsState: typeof import('./composables/actions')['resetActionsState']
  const resolveComponent: typeof import('vue')['resolveComponent']
  const revertPreviousActionStep: typeof import('./composables/state')['revertPreviousActionStep']
  const setActions: typeof import('./composables/actions')['setActions']
  const setMsg: typeof import('./composables/actions')['setMsg']
  const setState: typeof import('./composables/actions')['setState']
  const setStepsDesc: typeof import('./composables/actions')['setStepsDesc']
  const shallowReactive: typeof import('vue')['shallowReactive']
  const shallowReadonly: typeof import('vue')['shallowReadonly']
  const shallowRef: typeof import('vue')['shallowRef']
  const startAnimation: typeof import('./composables/animations')['startAnimation']
  const stepsHistory: typeof import('./composables/state')['stepsHistory']
  ...
  const toggleAniInput: typeof import('./composables/state')['toggleAniInput']
  ...
  const useGeneratePreference: typeof import('./composables/useGeneratePreference')['useGeneratePreference']
  ...
  const useLog: typeof import('./composables/useLog')['useLog']
  ...
  const useTour: typeof import('./composables/useTour')['useTour']
...
declare module 'vue' {
  interface ComponentCustomProperties {
    ...
    actions: typeof import('./composables/actions')['actions']
    actionsFile: typeof import('./composables/actions')['actionsFile']
    actionsState: typeof import('./composables/actions')['actionsState']
    addDefragmentationStep: typeof import('./composables/state')['addDefragmentationStep']
    addFileActionStep: typeof import('./composables/state')['addFileActionStep']
    addFormatStep: typeof import('./composables/state')['addFormatStep']
    aniInput: typeof import('./composables/state')['aniInput']
    asyncComputed: typeof import('@vueuse/core')['asyncComputed']
    autoResetRef: typeof import('@vueuse/core')['autoResetRef']
    checkDefragmentationStep: typeof import('./composables/state')['checkDefragmentationStep']
    checkValidSteps: typeof import('./composables/state')['checkValidSteps']
    ...
    createAndFormatDisk: typeof import('./composables/state')['createAndFormatDisk']
    ...
    disk: typeof import('./composables/state')['disk']
    eagerComputed: typeof import('@vueuse/core')['eagerComputed']
    effectScope: typeof import('vue')['effectScope']
    exportModal: typeof import('./composables/exportModal')['exportModal']
    extendRef: typeof import('@vueuse/core')['extendRef']
    files: typeof import('./composables/state')['files']
    fs: typeof import('./composables/state')['fs']
    generateAnimationState: typeof import('./composables/animations')['generateAnimationState']
    getCurrentInstance: typeof import('vue')['getCurrentInstance']
    getCurrentScope: typeof import('vue')['getCurrentScope']
    getInitialState: typeof import('./composables/animations')['getInitialState']
    h: typeof import('vue')['h']
    ignorableWatch: typeof import('@vueuse/core')['ignorableWatch']
    importModal: typeof import('./composables/importModal')['importModal']
    initAnimation: typeof import('./composables/animations')['initAnimation']
    initInitialState: typeof import('./composables/animations')['initInitialState']
    inject: typeof import('vue')['inject']
    inputs: typeof import('./composables/state')['inputs']
    ...
    log: typeof import('./composables/useLog')['log']
    ...
    nextStep: typeof import('./composables/animations')['nextStep']
    nextTick: typeof import('vue')['nextTick']
    notify: typeof import('./composables/useNotify')['notify']
    ...
    parseImportSteps: typeof import('./composables/state')['parseImportSteps']
    ...
    renderStateClass: typeof import('./composables/actions')['renderStateClass']
    resetActionsSelectedState: typeof import('./composables/actions')['resetActionsSelectedState']
    resetActionsState: typeof import('./composables/actions')['resetActionsState']
    resolveComponent: typeof import('vue')['resolveComponent']
    revertPreviousActionStep: typeof import('./composables/state')['revertPreviousActionStep']
    setActions: typeof import('./composables/actions')['setActions']
    setMsg: typeof import('./composables/actions')['setMsg']
    setState: typeof import('./composables/actions')['setState']
    setStepsDesc: typeof import('./composables/actions')['setStepsDesc']
    ...
    startAnimation: typeof import('./composables/animations')['startAnimation']
    stepsHistory: typeof import('./composables/state')['stepsHistory']
    ...
    toggleAniInput: typeof import('./composables/state')['toggleAniInput']
    ...
    useGeneratePreference: typeof import('./composables/useGeneratePreference')['useGeneratePreference']
    ...
    useLog: typeof import('./composables/useLog')['useLog']
    ...
    useModal: typeof import('./composables/useModal')['useModal']
    ...
    useNotify: typeof import('./composables/useNotify')['useNotify']
    ...
    useTour: typeof import('./composables/useTour')['useTour']
